...
mlflow.set_tracking_uri("https://dagshub.com/saurav3k2/Swiggy-Delivery-Time-Prediction.mlflow")
...
if __name__ == "__main__":
    ...
    model_registry_path = run_info.get("model_uri", f"runs:/{run_id}/{model_name}")
